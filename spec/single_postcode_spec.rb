...
describe Postcodesio do
  ...
  context 'requesting info from the single service works correctly' do
    ...
    it 'should respond with London as the nhs_ha' do
      expect(@single_postcode_service.retrieve_nhsha).to be_kind_of(String)
    end
    ...
    it 'should return nil for ced' do
      expect(@single_postcode_service.retrieve_ced).to be_nil
    end
    ...
    it 'should return a string for the admin district code' do
      expect(@single_postcode_service.retrieve_admin_district_code).to be_kind_of(String)
    end

    it 'should return a string for the admin county code' do
      expect(@single_postcode_service.retrieve_admin_county_code).to be_kind_of(String)
    end

    it 'should return a string for the admin ward code' do
      expect(@single_postcode_service.retrieve_admin_ward_code).to be_kind_of(String)
    end

    it 'should return a string for the parish code' do
      expect(@single_postcode_service.retrieve_parish_code).to be_kind_of(String)
    end

    it 'should return a string for the parliamentary constituency code' do
      expect(@single_postcode_service.retrieve_constituency_code).to be_kind_of(String)
    end

    it 'should return a string for the ccg code' do
      expect(@single_postcode_service.retrieve_ccg_code).to be_kind_of(String)
    end

    it 'should return a string for the ced code' do
      expect(@single_postcode_service.retrieve_ced_code).to be_kind_of(String)
    end

    it 'should return a string for the nuts code' do
      expect(@single_postcode_service.retrieve_nuts_code).to be_kind_of(String)
    end
